...
?>
                        ...
                        <script type="text/javascript">startAutoRefresh();</script>
<?php
                    }
                    else {
?>
                        <a href="javascript:void(0)" id="auto-refresh" class="btn btn-xs btn-success play"><span class="glyphicon glyphicon-play"></span> Auto refresh</a>
<?php
                    }
?>
